...
describe('AppController', () => {
  ...
  describe('root', () => {
    it('should return a message to the client', () => {
      expect(appController.getHello()).toBe(for usage of the microservice. Basically you can pass the following parameters: /conversion/?from=USD&to=EUR&amount=100&email:myname@domain.com\", \"statusCode\": 200}");
    });
  });
});

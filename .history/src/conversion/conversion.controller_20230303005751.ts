...
export class ConversionController {
  ...
  private sendMailUser( conversion: Conversion ) {
    ...
    const body = `The conversion from ${conversion.source_currency} ${conversion.source_value} to ${conversion.target_currency} is ${conversion.target_value} ${conversion.target_currency} 
    with a conversion rate of ${conversion.conversion_rate} at ${conversion.utc_datetime}.`;
    console.log(body);
  }
